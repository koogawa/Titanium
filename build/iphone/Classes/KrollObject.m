 ...
 * Copyright (c) 2009-2011 by Shimon, Inc. All Rights Reserved.
...
//@interface ShimonObject : NSObject
//@end

@interface ShimonObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ShimonObject class]])
		{
			for (NSString *key in [[(ShimonObject*)o modules] allKeys])
			{
