...
// in simulator we redefine to format for Shimon Developer console
...
{\
	NSString * exceptionName = [@"org.shimon." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.shimon";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIShimonNativeItemNone = -1, 
	UIShimonNativeItemSpinner = -2,
	UIShimonNativeItemProgressBar = -3,
	
	UIShimonNativeItemSlider = -4,
	UIShimonNativeItemSwitch = -5,
	UIShimonNativeItemMultiButton = -6,
	UIShimonNativeItemSegmented = -7,
	
	UIShimonNativeItemTextView = -8,
	UIShimonNativeItemTextField = -9,
	UIShimonNativeItemSearchBar = -10,
	
	UIShimonNativeItemPicker = -11,
	UIShimonNativeItemDatePicker = -12,
	
	UIShimonNativeItemInfoLight = -13,
	UIShimonNativeItemInfoDark = -14,
	
	UIShimonNativeItemDisclosure = -15,
	
	UIShimonNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Shimon instances of
